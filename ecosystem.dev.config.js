  ...
  apps: [
    {
      ...
      watch        : false,
      autorestart  : true,
      max_restarts : 5,       // evita loop infinito si hay crash
      restart_delay: 3000,    // espera 3s antes de reintentar
    ...
    },
    {
      ...
      watch        : false,
      autorestart  : true,
      max_restarts : 10,      // el tunnel puede caerse más seguido, se le da más margen
      restart_delay: 5000,
